...
#' Exercise 4: Write a program that checks if a given vector contains a
#' specified element.
#'
...
#' Exercise 5: Write a program that checks if a given number is between two
#' other numbers.
#'
...
#' Exercise 8: Write a program that checks the grades of students based on their
#' scores.
#'
#' Explanation: The program should assign grades based on the following
#' criteria:
#' - A: 90-100
#' - B: 80-89
#' - C: 70-79
...
#' Exercise 9: Write a program that checks if a given number is a perfect
#' square.
#'
#' Explanation: A perfect square is a number that can be expressed as the
...
#' Exercise 10: Write a program that checks if a given number is a palindrome.
#'
#' Explanation: A palindrome is a number that reads the same forwards and
#' backwards.
#'
#' Example: 121 is a palindrome because it reads the same forwards and
#' backwards.
#'
